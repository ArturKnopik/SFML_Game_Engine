...
namespace KOD {
class KOD_API World : public IWorld<KOD::GameObject>
{
...
public:
	...
	World(BoundingBox qTreeArea) : m_qTree(KOD::QuadTree<KOD::GameObject>(qTreeArea.m_position, qTreeArea.m_size, 0)) {}
	...
	std::unordered_map<size_t, std::shared_ptr<KOD::GameObject>>& getObjectList() { return m_gameObjects; }
};
} // namespace KOD

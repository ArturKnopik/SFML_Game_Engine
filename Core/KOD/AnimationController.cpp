...
KOD::AnimationController::AnimationController()
  :m_animationPtr(nullptr), m_currentFrame(0)
{
}
...
void KOD::AnimationController::play()
{
  m_isPausedAnimation = false;
}

void KOD::AnimationController::pause()
{
  m_isPausedAnimation = true;
}
...
void KOD::AnimationController::setLooped(bool looped)
{
  m_isLoopedAnimation = looped;
}

const KOD::Animation* KOD::AnimationController::getAnimation() const
{
  return m_animationPtr;
}

bool KOD::AnimationController::isLooped() const
{
  return m_isLoopedAnimation;
}

bool KOD::AnimationController::isPlaying() const
{
  return m_isPausedAnimation;
}
...
void KOD::AnimationController::setFrame(std::size_t newFrame, bool resetTime)
{
  if (m_animationPtr)
  {
    sf::IntRect rect = m_animationPtr->getFrame(newFrame);
  }
...
const std::shared_ptr<sf::Texture> KOD::AnimationController::getTexture() const
{
  return m_texture;
}

const size_t KOD::AnimationController::getCurrentFrame() const
{

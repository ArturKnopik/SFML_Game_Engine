...
KOD::Animation::~Animation() { m_texture = nullptr; }

void KOD::Animation::addFrame(KOD::Frame frame) { m_frameList.push_back(frame); }

void KOD::Animation::setTexture(std::shared_ptr<sf::Texture> texture) { m_texture = texture; }
...
const KOD::IntRect KOD::Animation::getFrame(std::size_t index) const
{
...
std::size_t KOD::Animation::getSize() const { return m_frameList.size(); }
